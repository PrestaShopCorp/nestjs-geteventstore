import {PersistentSubscriptionNakEventAction, WriteResult} from 'node-eventstore-client';
...
export class EventStoreService implements OnModuleDestroy, OnModuleInit {
    ...
    public writeMetadata(
        ...
        return this.eventStore.writeMetadata(stream, expectedStreamMetadataVersion, streamMetadata);
    }
}
