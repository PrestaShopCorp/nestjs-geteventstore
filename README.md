...
```shell script
docker run -p 20113:2113 -p 10113:1113 -d --name eventstore eventstore/eventstore --dev --enable-external-tcp --disable-external-tcp-tls --ext-ip=0.0.0.0 --int-ip=0.0.0.0 --enable-atom-pub-over-http=true
yarn
cd examples
yarn
yarn start
...
export class KillDragonHandler implements ICommandHandler<KillDragonCommand> {
  ...
  async execute(command: KillDragonCommand) {
    ...
    await hero.setStreamConfig({
      ...
      expectedRevision: ExpectedVersion.NoStream,
